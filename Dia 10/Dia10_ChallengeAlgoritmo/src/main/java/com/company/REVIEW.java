...
MongoCollection<Document> userData = mongoDatabase.getCollection("Personas");    //traigo para...ver debajo
Document result = userData.find().first();    //recuperar el primer resultado
//System.out.println(result.toJson());

//mongoDatabase.createCollection("users2");
MongoCollection<Document> userData2 = mongoDatabase.getCollection("users2");
